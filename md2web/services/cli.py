...
from services.md_extensions import NavigationConverterExtension, TextStylingConverterExtension, MarkerConverterExtension
...
def handle_args(args: argparse.Namespace):
    ...
    if args.input_path is not None:
        ...
        md_file_converter = FullMDtoHTMLFileConverter([NavigationConverterExtension(), MarkerConverterExtension(), TextStylingConverterExtension()])
